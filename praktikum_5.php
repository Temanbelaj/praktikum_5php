...
class Dispenser{
    ...
    public function volume(){
        return "<br>- Sasa membeli segelas air dengan volume " .self::VOLUME_GELAS ." ML";
    }
...
$Sasa = new Dispenser("Le Minerale", 2000, 4000);
echo $Sasa->volume();
echo $Sasa->hasilAkhir();
?>
              </div>
...
<body>
    <h1 class="h1 text-center">BANK SYARIAH</h1>
<?php
class Account{
    public $nomor;
    protected $saldo;
